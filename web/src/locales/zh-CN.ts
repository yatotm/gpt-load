export default {
  ...
  keys: {
    ...
    probeParamOverridesTooltip:
      "仅在主动探测请求中生效，支持通过 operations 数组按路径 set/remove，不影响正常用户请求",
    probeParamOverridesDescription:
      "推荐用于主动探测时下调推理/思考强度、限制输出或覆盖特定校验参数。path 使用点号分隔，具体字段请以对应上游模型 API 文档为准。",
    ...
    pauseKey: "暂停密钥",
    disableKey: "停用密钥",
    confirmPauseKey: '确定要暂停密钥"{key}"吗？',
    confirmDisableKey: '确定要停用密钥"{key}"吗？',
    ...
    editKeyMeta: "编辑备注和优先级",
    keyMetaUpdated: "密钥信息已更新",
    overrideShort: "覆写",
    singleKeySettings: "单 Key 设置",
    keyFingerprint: "密钥指纹",
    basicSettings: "基础设置",
    basicSettingsHint: "只覆盖这个密钥的优先级和补充说明，不影响分组默认配置。",
    keyInheritSummary: "继承分组默认配置",
    keyOverrideSummary: "已覆写 {configCount} 项配置 / {probeCount} 份探测参数",
    keyConfigEmptyHint: "不添加任何配置项时，这个 Key 会完整继承分组的主动探测与被动校验策略。",
    notes: "备注",
    editKeyNotes: "编辑密钥备注",
    enterNotes: "请输入备注...",
    keyConfigOverrides: "单 Key 配置覆盖",
    keyConfigOverridesHint: "留空或填写空对象表示继承分组。",
    ...
    invalidKeyConfigJson: "单 Key 配置覆盖必须是有效的 JSON",
    invalidKeyProbeParamOverridesJson: "单 Key 主动探测参数覆盖必须是有效的 JSON",
    loadKeyConfigOptionsFailed: "加载单 Key 可配置参数失败",
    switchOn: "开启",
    switchOff: "关闭",
    cardView: "卡片视图",
    listView: "列表视图",
