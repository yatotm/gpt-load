export default {
  ...
  keys: {
    ...
    probeParamOverrides: "アクティブプローブ用オーバーライド",
    ...
    probeParamOverridesTooltip:
      "アクティブプローブのリクエストにのみ適用されます。通常のユーザーリクエストには影響せず、path 指定の set/remove 操作をサポートします。",
    probeParamOverridesDescription:
      "推論/思考強度の削減、出力制限、プローブ専用の検証パラメーター上書きに使えます。path はドット区切りで、具体的なフィールド名は各上流モデル API の仕様に従ってください。",
    ...
    pauseKey: "キーを一時停止",
    disableKey: "キーを停止",
    confirmPauseKey: 'キー "{key}" を一時停止しますか？',
    confirmDisableKey: 'キー "{key}" を停止しますか？',
    ...
    editKeyMeta: "備考と優先度を編集",
    keyMetaUpdated: "キー情報が更新されました",
    overrideShort: "上書き",
    singleKeySettings: "キー単位設定",
    keyFingerprint: "キー識別子",
    basicSettings: "基本設定",
    basicSettingsHint: "このキーの優先度と備考だけを上書きし、グループ既定値は変更しません。",
    keyInheritSummary: "グループ既定値を継承中",
    keyOverrideSummary: "設定上書き {configCount} 件 / プローブ上書き {probeCount} 件",
    keyConfigEmptyHint:
      "ここで設定項目を追加しなければ、このキーはグループのアクティブプローブと受動検証ポリシーをそのまま継承します。",
    notes: "備考",
    editKeyNotes: "キー備考を編集",
    enterNotes: "備考を入力してください...",
    keyConfigOverrides: "キー単位の設定上書き",
    keyConfigOverridesHint: "空欄または空オブジェクトの場合はグループ設定を継承します。",
    keyConfigOverridesPlaceholder:
      '｛\n  "active_probe_enabled": false,\n  "blacklist_threshold": 0\n｝',
    keyProbeParamOverrides: "キー単位のアクティブプローブ上書き",
    keyProbeParamOverridesHint:
      "このキーのアクティブプローブ要求にのみ適用されます。空欄または空オブジェクトの場合はグループ設定を継承します。",
    keyProbeParamOverridesDescription:
      "一部の特別なキーだけ thinking の抑制、出力制限、またはプローブ専用パラメーターの変更をしたい場合に使います。",
    keyProbeParamOverridesPlaceholder:
      '｛\n  "operations": [\n    ｛\n      "mode": "set",\n      "path": "generationConfig.thinkingConfig.thinkingBudget",\n      "value": 128\n    ｝\n  ]\n｝',
    invalidKeyConfigJson: "キー単位の設定上書きは有効な JSON である必要があります",
    invalidKeyProbeParamOverridesJson:
      "キー単位のアクティブプローブ上書きは有効な JSON である必要があります",
    loadKeyConfigOptionsFailed: "キー単位で設定可能な項目の読み込みに失敗しました",
    switchOn: "オン",
    switchOff: "オフ",
    cardView: "カード表示",
    listView: "リスト表示",
    ...
    rateShort: "比率",
    usedShort: "使用",
    probeRateShort: "プローブ {rate}",
    probeLastShort: "直近プローブ",
    probeNeverShort: "未プローブ",
    probeFailedShort: "失敗",
  ...
  logs: {
    ...
    showProbeLogs: "アクティブプローブを表示",
    probeRequest: "アクティブプローブ",
