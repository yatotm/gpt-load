export default {
  ...
  keys: {
    ...
    probeParamOverrides: "Active Probe Overrides",
    ...
    probeParamOverridesTooltip:
      "Only applies to active probe requests. Supports path-based set/remove operations without affecting normal user traffic.",
    probeParamOverridesDescription:
      "Use this to lower reasoning/thinking effort, cap output, or override probe-only validation parameters. Paths use dot notation; field names must follow the upstream model API documentation.",
    ...
    confirmPauseKey: 'Pause key "{key}"?',
    confirmDisableKey: 'Disable key "{key}"?',
    ...
    editKeyMeta: "Edit notes and priority",
    keyMetaUpdated: "Key details updated",
    overrideShort: "OVR",
    ...
    keyConfigEmptyHint:
      "Without any config item here, this key fully inherits the group's active probe and passive validation policy.",
    notes: "Notes",
    editKeyNotes: "Edit key notes",
    enterNotes: "Enter notes...",
    keyConfigOverrides: "Per-key config overrides",
    keyConfigOverridesHint: "Leave empty or use an empty object to inherit the group.",
    keyConfigOverridesPlaceholder:
      '｛\n  "active_probe_enabled": false,\n  "blacklist_threshold": 0\n｝',
    keyProbeParamOverrides: "Per-key active probe overrides",
    keyProbeParamOverridesHint:
      "Only applies to active probe requests for this key. Leave empty or use an empty object to inherit the group.",
    keyProbeParamOverridesDescription:
      "Useful for a few special keys that need lower thinking effort, tighter output limits, or custom probe-only request parameters.",
    keyProbeParamOverridesPlaceholder:
      '｛\n  "operations": [\n    ｛\n      "mode": "set",\n      "path": "generationConfig.thinkingConfig.thinkingBudget",\n      "value": 128\n    ｝\n  ]\n｝',
    invalidKeyConfigJson: "Per-key config overrides must be valid JSON",
    invalidKeyProbeParamOverridesJson: "Per-key active probe overrides must be valid JSON",
    loadKeyConfigOptionsFailed: "Failed to load per-key configurable options",
    switchOn: "On",
    switchOff: "Off",
    cardView: "Card view",
    listView: "List view",
    ...
    rateShort: "Rate",
    usedShort: "Used",
    probeRateShort: "Probe {rate}",
    probeLastShort: "Last Probe",
    probeNeverShort: "No Probe",
  ...
  logs: {
    ...
    showProbeLogs: "Show active probes",
    probeRequest: "Active Probe",
