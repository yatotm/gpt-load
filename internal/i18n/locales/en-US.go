...
var MessagesEnUS = map[string]string{
	...
	"config.active_probe_enabled":                 "Enable Active Probing",
	"config.active_probe_enabled_desc":            "When enabled, the system actively probes every key on a fixed interval and automatically blacklists or restores keys based on failure rate.",
	"config.active_probe_interval_seconds":        "Active Probe Interval (seconds)",
	"config.active_probe_interval_seconds_desc":   "Interval in seconds for active connectivity probes on each key.",
	"config.active_probe_timeout_seconds":         "Active Probe Timeout (seconds)",
	"config.active_probe_timeout_seconds_desc":    "Timeout in seconds for a single active probe request. Timeouts count as failures.",
	"config.active_probe_window_minutes":          "Active Probe Window (minutes)",
	...
	"error.invalid_probe_param_overrides": "Invalid active probe parameter overrides: {{.error}}",
